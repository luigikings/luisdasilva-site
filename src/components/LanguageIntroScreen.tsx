    ...
    <div className="flex min-h-screen flex-col items-center justify-center gap-10 px-4 text-center">
      ...
      >
        ...
        <motion.button
          ...
          className="rounded-pixel bg-highlight px-10 py-3 font-pixel text-sm uppercase tracking-[0.45em] text-charcoal shadow-pixel transition-transform duration-200 hover:-translate-y-1"
